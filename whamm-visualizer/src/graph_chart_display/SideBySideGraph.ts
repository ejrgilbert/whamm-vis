...
// /**
//  * How to map the data from a `parseCSV.CSVRow[]` to a `cDFuncs.graphChartData`
//  * @param lines 
//  * @returns 
//  */
// function dataMapping(lines: parseCSV.CSVRow[]): cDFuncs.graphChartData{
//     let fid = lines[0]["value(s)"][0]!;
//     let entry: cDFuncs.graphChartData = {
//         graphChart: true,
//         nodeName: fid,
//         edges: [],
